              ...
              <table width="100%" cellspacing="0" cellpadding="0">
               <tbody>
                <tr>
                 ...
                 <td  align="left" style="float:left;vertical-align:middle"> <p style="font-family:'Roboto-Medium',sans-serif;font-size:16px;font-weight:normal;font-style:normal;line-height:1.5;font-stretch:normal;color:#212121;margin:16px 0px">Hi ,</p>
				 </td>
                </tr>
               </tbody>
              </table> </td>
